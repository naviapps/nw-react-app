...
program
  .option('--webpack <path>', 'webpack', require.resolve('../config/webpack.config.dev'))
  .option('--webpack-dev-server <path>', 'webpack-dev-server', require.resolve('../config/webpackDevServer.config'))
  .parse(process.argv);
